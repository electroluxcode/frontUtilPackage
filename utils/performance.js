        ...
        try {
            ...
            var times = {
                result: [
                    ...
                    { key: 'FCP', desc: '(白屏)First Contentful Paint(首次内容渲染)表示浏览器渲染出第一个内容的时间', value: t.responseStart - t.navigationStart, solution: "这可以理解为用户拿到你的资源占用的时间，加异地机房了么，webpack代码分包了吗，dll有吗，gzip（压缩空格），js，css    压缩" },
